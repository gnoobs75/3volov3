...
const PARTICLE_CONFIGS: Dictionary = {
	...
	INTESTINAL_TRACT: {
		"color": Color(0.4, 0.25, 0.18, 0.35),
		"count": 25,
		"speed": 0.3,
		"size": 0.05,
		"lifetime": 8.0,
